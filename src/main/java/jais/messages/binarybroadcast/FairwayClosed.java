 ...
 */
public class FairwayClosed extends BinaryBroadcastMessage {
     ...
     * @param packets 
     */
    public FairwayClosed( String source, AISPacket... packets ) {
    ...
    public BinaryBroadcastMessageType getSubType() {
        return BinaryBroadcastMessageType.FAIRWAY_CLOSED;
    }
}